...
if __name__ == '__main__':
    ...
    ideals = {1: [2], 2: [4], 3: [4, 2], 4: [4, 4], 5: [8, 2], 6: [8, 4], 7: [8, 4, 2], 8: [8, 4, 4], 9: [8, 8, 2],
              10: [16, 4], 11: [16, 4, 2]}
    ideals_c = {1: [1], 2: [0, 1], 3: [1, 1], 4: [0, 2], 5: [1, 0, 1], 6: [0, 1, 1], 7: [1, 1, 1], 8: [0, 2, 1],
                9: [1, 0, 2], 10: [0, 1, 0, 1], 11: [1, 1, 0, 1]}
    ...
    test_list = [  # numberOfTiles_heuristic,
        ...
        min_perfect_heuristic, min_perfect_heuristic_d,
        #ratio_heuristic_t, #adjacency_ldiff_heuristic,
        sum2_diff_heuristic_e,
